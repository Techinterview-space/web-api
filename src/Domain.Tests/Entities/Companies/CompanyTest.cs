...
{
    [Fact]
    public void Ctor_WithoutSlug_SlugAutoGenerated()
    {
        ...
        Assert.NotNull(company.Slug);
        Assert.StartsWith("test-company-", company.Slug);
    }

    [Fact]
    public void Ctor_WithCustomSlug_CustomSlugUsed()
    {
        var company = new Company(
            "Test Company",
            "Description",
    ...
    [Fact]
    public void Ctor_WithCustomSlugNeedingNormalization_SlugNormalized()
    {
        var company = new Company(
            "Test Company",
            "Description",
    ...
    [InlineData(null)]
    [InlineData("")]
    public void Ctor_WithNullOrEmptySlug_SlugAutoGenerated(string slug)
    {
        var company = new Company(
            "Test Company",
            "Description",
