...
public class MarkdownToTelegramHtml
{
    ...
    private static string ConvertHeadersToBold(string text)
    {
    ...
    private static string ConvertBoldText(string text)
    {
    ...
    private static string ConvertItalicText(string text)
    {
    ...
    private static string ConvertCodeBlocks(string text)
    {
        ...
        return Regex.Replace(text, codeBlockPattern, match =>
        {
