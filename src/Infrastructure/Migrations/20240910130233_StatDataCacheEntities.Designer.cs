...
namespace Domain.Migrations
{
    ...
    [Migration("20240910130233_StatDataCacheEntities")]
    partial class StatDataCacheEntities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.StatData.StatDataCache", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("StatDataCache", (string)null);
                });

            modelBuilder.Entity("Domain.Entities.StatData.StatDataCacheItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("PreviousStatDataCacheItemId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("StatDataCacheId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("PreviousStatDataCacheItemId")
                        .IsUnique();

                    b.HasIndex("StatDataCacheId");

                    b.ToTable("StatDataCacheItems", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entities.StatData.StatDataCacheItem", b =>
                {
                    b.HasOne("Domain.Entities.StatData.StatDataCacheItem", "PreviousStatDataCacheItem")
                        .WithOne("NextStatDataCacheItem")
                        .HasForeignKey("Domain.Entities.StatData.StatDataCacheItem", "PreviousStatDataCacheItemId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("Domain.Entities.StatData.StatDataCache", "StatDataCache")
                        .WithMany("StatDataCacheItems")
                        .HasForeignKey("StatDataCacheId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("PreviousStatDataCacheItem");

                    b.Navigation("StatDataCache");
                });
            ...
            modelBuilder.Entity("Domain.Entities.StatData.StatDataCache", b =>
                {
                    b.Navigation("StatDataCacheItems");
                });

            modelBuilder.Entity("Domain.Entities.StatData.StatDataCacheItem", b =>
                {
                    b.Navigation("NextStatDataCacheItem");
                });
