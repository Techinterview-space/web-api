...
namespace Domain.Migrations
{
    ...
    [Migration("20240430171902_SalairesSurveyEntitiesAdded")]
    partial class SalairesSurveyEntitiesAdded
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.Questions.SalariesSurveyQuestion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("SalariesSurveyQuestions", (string)null);

                    b.HasData(
                        new
                        {
                            Id = new Guid("703dc7ad-1395-4c09-bb76-a08b639134e4"),
                            CreatedAt = new DateTimeOffset(new DateTime(2024, 4, 30, 5, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 5, 0, 0, 0)),
                            Title = "Ожидали ли вы, что медианная и средняя зарплаты будут такими, какими они оказались?",
                            UpdatedAt = new DateTimeOffset(new DateTime(2024, 4, 30, 5, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 5, 0, 0, 0))
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.Questions.SalariesSurveyReply", b =>
                {
                    ...
                    b.Property<Guid>("SalariesSurveyQuestionId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("SalariesSurveyQuestionId");
            ...
            modelBuilder.Entity("Domain.Entities.Questions.SalariesSurveyReply", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.Questions.SalariesSurveyQuestion", "SalariesSurveyQuestion")
                        .WithMany("Replies")
                        .HasForeignKey("SalariesSurveyQuestionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("CreatedByUser");

                    b.Navigation("SalariesSurveyQuestion");
                });
