...
📩 Для связи: @asematay";
    ...
    public const string MultilineText20 = @"#вакансия #frontend #web3 #react #remote #fulltime

Вакансия: Frontend Developer в Web3
Компания: Lagrange Labs
Вилка: от 4 500 до 6 200 USD
Условия: удаленно, фулл тайм

Обязанности:
— Разработка и поддержка интерфейсов для взаимодействия с ZK-сопроцессорами.
— Интеграция веб-приложений с блокчейн-кошельками (Metamask, WalletConnect) и смарт-контрактами.
— Оптимизация производительности фронтенда для визуализации сложных данных из блокчейна.

Требования:
— Опыт коммерческой разработки на React/Next.js от 3 лет.
— Глубокое понимание библиотек ethers.js или viem/wagmi.
— Опыт работы с TypeScript и современными инструментами стилизации (Tailwind/Styled Components).
— Умение создавать чистый, поддерживаемый код и работать с UX-метриками.
...
Контакты: mura99hr";
    ...
    [InlineData(MultilineText20, 4_500d, 6_200d)]
