...
public class DeactivateSalarySubscriptionHandler : IRequestHandler<DeactivateSalarySubscriptionCommand, Nothing>
{
    private readonly DatabaseContext _context;
    private readonly IAuthorization _authorization;

    public DeactivateSalarySubscriptionHandler(
    ...
    public async Task<Nothing> Handle(
        DeactivateSalarySubscriptionCommand request,
